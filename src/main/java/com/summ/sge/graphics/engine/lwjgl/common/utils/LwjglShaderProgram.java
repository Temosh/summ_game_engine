...
public class LwjglShaderProgram {
	...
	public LwjglShaderProgram(String vertexSource, String fragmentSource) throws LWJGLException {
	 ...
	 */
	public LwjglShaderProgram(String vertexShader, String fragmentShader, Map<Integer, String> attributes) throws LWJGLException {
